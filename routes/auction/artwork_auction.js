...
router.get("/artwork_auction/:listing_no", function (request, response) {
  ...
  const sql =
    "SELECT art_bid_no, art_name, art_explain, initial_price, time_ending, time_starting, bid_participant, highest_bid, bid_upload_user FROM listing,bid WHERE listing.listing_no = bid.art_bid_no and listing_no = ?";
